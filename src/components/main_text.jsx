    ...
    return (
        <div className="text-wrapper main-wrapper card-wrapper main-text-wrapper">
            ...
            <div id="text-main" className="animated">
                That simple SPA app can be used to check your's or other user's GitHub repositories. All you need to do is just to fill username and click show repositories button.
